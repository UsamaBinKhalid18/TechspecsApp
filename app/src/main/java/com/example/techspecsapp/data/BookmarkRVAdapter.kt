...
import com.example.techspecsapp.DetailActivityBookMark
import com.example.techspecsapp.R
import com.google.gson.Gson

class BookmarkRVAdapter : RecyclerView.Adapter<BookmarkRVAdapter.SearchViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        ...
        holder.cvSearch.setOnClickListener {
            val intent = Intent(it.context, DetailActivityBookMark::class.java)
