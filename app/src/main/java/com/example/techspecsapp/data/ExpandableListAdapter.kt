...
class ExpandableListAdapter(
    ...
    private val listMap: Map<String, List<String>>
    ...
    override fun getGroupView(p0: Int, p1: Boolean, p2: View?, p3: ViewGroup?): View {
        val p = LayoutInflater.from(context)
            .inflate(com.example.techspecsapp.R.layout.list_group, p3, false)
    ...
    override fun getChildView(
        ...
        val p = LayoutInflater.from(context)
            .inflate(com.example.techspecsapp.R.layout.list_item, p4, false)
        val expandedListTextView =
            p.findViewById(com.example.techspecsapp.R.id.expandedListItem) as TextView
