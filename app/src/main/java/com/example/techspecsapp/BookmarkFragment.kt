...
import com.example.techspecsapp.data.BookmarkRVAdapter
...
class BookmarkFragment(private val repository: Repository) : Fragment() {
    private val adapter=BookmarkRVAdapter()
    ...
    override fun onStart() {
        ...
        lifecycleScope.launch {
            withContext(Dispatchers.IO) {
                list = repository.getBookmarkResponses()
            }
